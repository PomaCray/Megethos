...
const ContactForm = () => {
  ...
  return (
    <div className="font-mono text-primary/100">
      ...
      <form onSubmit={handleSubmit} className="mt-4 md:w-100 lg:w-150" noValidate>
        <div className="mb-4">
          ...
          <input
            ...
            type="text"
            className="rounded-full border border-white p-2 w-full"
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            className="rounded-lg border border-white p-2 w-full"
            rows={4}
        ...
        <div className="flex gap-2">
          <button
            type="submit"
            className="hover:translate-x-2 hover:scale-105 hover:shadow-lg transition-all duration-300 bg-primary text-green-500 bg-white py-2 px-4 rounded-full"
          >
            Send
          </button>
          ...
          <button
            type="button"
            onClick={handleClear}
            className="py-2 px-4 hover:scale-105 hover:shadow-lg transition-all duration-300 rounded-full border border-white"
          >
            Clear
          </button>
        </div>
